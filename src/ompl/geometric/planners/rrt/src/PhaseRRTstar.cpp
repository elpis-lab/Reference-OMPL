/*
Copied skeleton PhaseRRTstar.cpp
author: @shuaiyy
*/
  ...
  : base::Planner(si, "PhaseRRTstar"), phaseSampler_(std::make_unique<PhaseStateSampler>(si->getStateSpace()))
{
    ...
    Planner::declareParam<double>("range", this, &PhaseRRTstar::setRange, &PhaseRRTstar::getRange, "0.:1.:10000.");
    Planner::declareParam<double>("d_alpha_min", this, &PhaseRRTstar::setDAlphaMin, &PhaseRRTstar::getDAlphaMin,
                                  "0.:.001:1.");
    Planner::declareParam<double>("d_alpha_max", this, &PhaseRRTstar::setDAlphaMax, &PhaseRRTstar::getDAlphaMax,
                                  "0.:.01:1.");
    Planner::declareParam<double>("sample_sigma", this, &PhaseRRTstar::setSampleSigma, &PhaseRRTstar::getSampleSigma,
                                  "0.:.01:10.");
    Planner::declareParam<double>("uniform_fraction", this, &PhaseRRTstar::setUniformFraction,
                                  &PhaseRRTstar::getUniformFraction, "0.:.05:1.");
    Planner::declareParam<double>("goal_bias", this, &PhaseRRTstar::setGoalBias, &PhaseRRTstar::getGoalBias, "0.:.05:1.");
    Planner::declareParam<double>("rewire_factor", this, &PhaseRRTstar::setRewireFactor, &PhaseRRTstar::getRewireFactor,
                                  "1.0:0.01:2.0");
    Planner::declareParam<bool>("use_k_nearest", this, &PhaseRRTstar::setKNearest, &PhaseRRTstar::getKNearest, "0,1");
    Planner::declareParam<bool>("delay_collision_checking", this, &PhaseRRTstar::setDelayCC, &PhaseRRTstar::getDelayCC, "0,1");
    Planner::declareParam<bool>("tree_pruning", this, &PhaseRRTstar::setTreePruning, &PhaseRRTstar::getTreePruning, "0,1");
    Planner::declareParam<double>("prune_threshold", this, &PhaseRRTstar::setPruneThreshold, &PhaseRRTstar::getPruneThreshold,
                                  "0.:.01:1.");
    Planner::declareParam<bool>("pruned_measure", this, &PhaseRRTstar::setPrunedMeasure, &PhaseRRTstar::getPrunedMeasure, "0,1");
    Planner::declareParam<bool>("informed_sampling", this, &PhaseRRTstar::setInformedSampling, &PhaseRRTstar::getInformedSampling,
                                "0,1");
    Planner::declareParam<bool>("sample_rejection", this, &PhaseRRTstar::setSampleRejection, &PhaseRRTstar::getSampleRejection,
                                "0,1");
    Planner::declareParam<bool>("new_state_rejection", this, &PhaseRRTstar::setNewStateRejection,
                                &PhaseRRTstar::getNewStateRejection, "0,1");
    Planner::declareParam<bool>("use_admissible_heuristic", this, &PhaseRRTstar::setAdmissibleCostToCome,
                                &PhaseRRTstar::getAdmissibleCostToCome, "0,1");
    Planner::declareParam<bool>("ordered_sampling", this, &PhaseRRTstar::setOrderedSampling, &PhaseRRTstar::getOrderedSampling,
                                "0,1");
    Planner::declareParam<unsigned int>("ordering_batch_size", this, &PhaseRRTstar::setBatchSize, &PhaseRRTstar::getBatchSize,
                                        "1:100:1000000");
    Planner::declareParam<bool>("focus_search", this, &PhaseRRTstar::setFocusSearch, &PhaseRRTstar::getFocusSearch, "0,1");
    Planner::declareParam<unsigned int>("number_sampling_attempts", this, &PhaseRRTstar::setNumSamplingAttempts,
                                        &PhaseRRTstar::getNumSamplingAttempts, "10:10:100000");

    addPlannerProgressProperty("iterations INTEGER", [this] { return numIterationsProperty(); });
    addPlannerProgressProperty("best cost REAL", [this] { return bestCostProperty(); });
}

ompl::geometric::PhaseRRTstar::~PhaseRRTstar()
{
    freeMemory();
}
...
void ompl::geometric::PhaseRRTstar::clear()
{
    setup_ = false;
    Planner::clear();
    sampler_.reset();
...
ompl::base::PlannerStatus ompl::geometric::PhaseRRTstar::solve(const base::PlannerTerminationCondition &ptc)
{
    checkValidity();
    ...
    while (ptc == false)
    {
        ...
        if (si_->checkMotion(nmotion->state, dstate))
        {
            ...
            if (delayCC_)
            {
                ...
                {
                    /* phase window: skip neighbors that may not be a parent
                       (leave valid[] untouched, they may still be rewired) */
                    if (nbh[*i] != nmotion && !parentOK(nbh[*i]))
                        continue;
                    if (nbh[*i] == nmotion ||
            ...
            else  // if not delayCC
            {
                ...
                for (std::size_t i = 0; i < nbh.size(); ++i)
                {
                    if (nbh[i] != nmotion)
                    {
                        incCosts[i] = opt_->motionCost(nbh[i]->state, motion->state);
                        costs[i] = opt_->combineCosts(nbh[i]->cost, incCosts[i]);
                        /* phase window: this neighbor may not be a parent
                           (costs stay cached for the rewiring pass below) */
                        if (!parentOK(nbh[i]))
                            continue;
            ...
            for (std::size_t i = 0; i < nbh.size(); ++i)
            {
                /* only later neighbors may be re-parented through the new motion;
                   this changes their route and cost, never their phase */
                if (!rewireOK(nbh[i]))
                    continue;
...
void ompl::geometric::PhaseRRTstar::getNeighbors(Motion *motion, std::vector<Motion *> &nbh) const
{
...
void ompl::geometric::PhaseRRTstar::removeFromParent(Motion *m)
{
...
void ompl::geometric::PhaseRRTstar::updateChildCosts(Motion *m)
{
...
void ompl::geometric::PhaseRRTstar::freeMemory()
{
    if (nn_)
    {
...
void ompl::geometric::PhaseRRTstar::getPlannerData(base::PlannerData &data) const
{
...
int ompl::geometric::PhaseRRTstar::pruneTree(const base::Cost &pruneTreeCost)
{
    // Variable
...
void ompl::geometric::PhaseRRTstar::addChildrenToList(std::queue<Motion *, std::deque<Motion *>> *motionList, Motion *motion)
{
...
bool ompl::geometric::PhaseRRTstar::keepCondition(const Motion *motion, const base::Cost &threshold) const
{
...
ompl::base::Cost ompl::geometric::PhaseRRTstar::solutionHeuristic(const Motion *motion) const
{
...
void ompl::geometric::PhaseRRTstar::setTreePruning(const bool prune)
{
...
void ompl::geometric::PhaseRRTstar::setPrunedMeasure(bool informedMeasure)
{
    if (static_cast<bool>(opt_) == true)
    {
        if (opt_->hasCostToGoHeuristic() == false)
...
void ompl::geometric::PhaseRRTstar::setInformedSampling(bool informedSampling)
{
    if (static_cast<bool>(opt_) == true)
    {
        if (opt_->hasCostToGoHeuristic() == false)
...
void ompl::geometric::PhaseRRTstar::setSampleRejection(const bool reject)
{
    if (static_cast<bool>(opt_) == true)
    {
        if (opt_->hasCostToGoHeuristic() == false)
...
void ompl::geometric::PhaseRRTstar::setOrderedSampling(bool orderSamples)
{
...
void ompl::geometric::PhaseRRTstar::allocSampler()
{
...
bool ompl::geometric::PhaseRRTstar::sampleUniform(base::State *statePtr)
{
...
void ompl::geometric::PhaseRRTstar::calculateRewiringLowerBounds()
{
