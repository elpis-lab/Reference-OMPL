...
namespace ompl::binding::base
{
    ...
    void initSpaces_OwenStateSpace(nanobind::module_ &m);
    ...
    void initSpaces_TrochoidStateSpace(nanobind::module_ &m);
    void initSpaces_VanaOwenStateSpace(nanobind::module_ &m);
    void initSpaces_VanaStateSpace(nanobind::module_ &m);
