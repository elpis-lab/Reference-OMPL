...
void ompl::binding::geometric::initPlannersInformedtrees_EITstar(nb::module_ &m)
{
    nb::class_<og::EITstar, ob::Planner>(m, "EITstar")
        ...
        .def("setInitialNumberOfSparseCollisionChecks", &og::EITstar::setInitialNumberOfSparseCollisionChecks,
             nb::arg("numChecks"))
        ...
        .def("isForwardQueueEmpty", &og::EITstar::isForwardQueueEmpty)
        .def("isReverseQueueEmpty", &og::EITstar::isReverseQueueEmpty)
        .def("getForwardEffort", &og::EITstar::getForwardEffort);
}
